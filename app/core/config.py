...
class Settings(BaseSettings):
    ...
    # Brevo Configuration (API based)
    BREVO_API_KEY: Optional[str] = os.getenv("BREVO_API_KEY")
    MAIL_FROM: str = os.getenv("MAIL_FROM", "noreply@isentrytechnologies.com")

    # SendGrid Configuration (Primary)
    SENDGRID_API_KEY: str = os.getenv("SENDGRID_API_KEY", "")
    SENDGRID_FROM_EMAIL: str = os.getenv("SENDGRID_FROM_EMAIL", "noreply@isentrytechnologies.com")
    SENDGRID_FROM_NAME: str = os.getenv("SENDGRID_FROM_NAME", "TEAM IQ")
